...
public class DoubleMatch extends Match {
    ...
    public static String getSelectString() {
        return "SELECT gr.grID, mt.mtID, mtNr, 0 AS mtMS, mtRound, mtMatch, 0 as mtReverse, mtTable, mtDateTime, mtTimestamp, " +
               ...
               " FROM MtDoubleList mt INNER JOIN GrList gr ON mt.grID = gr.grID " +
    ...
    public DoubleMatch(Group gr, ResultSet rs) throws SQLException {
        this.gr = gr;
    ...
    public String aToString(boolean withAssoc, boolean withNr, boolean withFlag) {
        if (plA != null && plA.plNr != 0)
            return plA.toString(withAssoc, withNr, withFlag) + plB.toString(withAssoc, withNr, withFlag);
    ...
    public String xToString(boolean withAssoc, boolean withNr, boolean withFlag) {
        if (plX != null && plX.plNr != 0)
            return plX.toString(withAssoc, withNr, withFlag) + plY.toString(withAssoc, withNr, withFlag);
